---
title: 'Aligning multiple methods to inform catchment planning in the Brewer Lake Watershed, Arkansas, USA'
...
- Discuss how the findings guided management decisions. Mention the question-centric approach. Mention the need for being non-prescriptive, which gives managers capacity to negotiate with stakeholders about where actions are implemented.  
...
- Multi-purpose planning is hard. Trade-offs are challenging to think through. Secondary objectives were important here, but played little role in decision making. Misalignment between physical processes and jurisdictional boundaries (Cohen and Davidson 2011).  
- Watershed prioritization is simply the first step. More detailed analyses are needed for site-scale design. The temporal scale of watershed planning is long-term, so we need to arm decision-makers with general targets and ranges of effort (not just a hit list of projects). 
